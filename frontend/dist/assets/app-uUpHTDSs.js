(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))t(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&t(r)}).observe(document,{childList:!0,subtree:!0});function a(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function t(s){if(s.ep)return;s.ep=!0;const o=a(s);fetch(s.href,o)}})();const p="/api/posts",q="/api/auth",z="/api/comments",ce="https://i.postimg.cc/KvF0rh0Q/custom-default-avatar.png",de=document.body,ue=document.querySelectorAll(".user-icon"),v=document.getElementById("userMenuDetails"),O=document.getElementById("authModal"),Se=document.getElementById("closeModal"),T=document.getElementById("loginTab"),M=document.getElementById("registerTab"),$e=document.querySelectorAll(".write-post"),Ie=document.querySelector(".search-icon"),Q=document.getElementById("mobileSearch"),fe=document.querySelector(".menu-toggle"),j=document.getElementById("mobileMenu"),U=document.querySelector(".logo"),Pe=document.querySelector(".all-posts-btn"),Be=document.getElementById("myPosts"),Ce=document.getElementById("savedPosts"),Te=document.getElementById("profile-edit"),Me=document.getElementById("settings"),H=document.getElementById("themeToggle"),R=document.documentElement;function d(e,n="info",a=5e3){const t=document.getElementById("toast-container");if(!t)return;const s=document.createElement("div");s.className=`toast toast-${n}`;const o=document.createElement("i");n==="success"?o.className="fas fa-check-circle":n==="error"?o.className="fas fa-exclamation-circle":o.className="fas fa-info-circle",s.appendChild(o);const r=document.createElement("span");r.textContent=e,s.appendChild(r),t.appendChild(s),setTimeout(()=>{s.style.animation="slideOut 0.5s forwards",s?.addEventListener("animationend",()=>s.remove())},a)}function Ue(){fe?.addEventListener("click",e=>{e.stopPropagation(),v.classList.contains("show")&&v.classList.remove("show"),j.classList.toggle("active")})}function qe(){U?.addEventListener("click",()=>{window.location.href="index.html"}),Pe?.addEventListener("click",()=>{window.location.href="all-posts.html"}),Be?.addEventListener("click",()=>{window.location.href="my-posts.html"}),Te?.addEventListener("click",()=>{window.location.href="dashboard.html"}),Ce?.addEventListener("click",()=>{window.location.href="saved.html"}),Me?.addEventListener("click",()=>{window.location.href="settings.html"})}function Ae(){T?.addEventListener("click",()=>{$.classList.remove("hidden"),I.classList.add("hidden"),T.classList.add("active"),M.classList.remove("active")}),M?.addEventListener("click",()=>{I.classList.remove("hidden"),$.classList.add("hidden"),M.classList.add("active"),T.classList.remove("active")}),Se?.addEventListener("click",()=>{O.classList.add("hidden")})}function Fe(){Ie?.addEventListener("click",()=>{Q.classList.toggle("show"),Q.classList.contains("show")&&Q?.querySelector("input").focus()})}function xe(){$e.forEach(e=>{e?.addEventListener("click",n=>{const a=localStorage.getItem("user"),t=a?JSON.parse(a):null;!t||!t.id?(n.preventDefault(),O.classList.remove("hidden"),T.classList.add("active"),M.classList.remove("active"),$.classList.remove("hidden"),I.classList.add("hidden")):(localStorage.removeItem("editSlug"),window.location.href="write.html")})})}function Ne(){H?.addEventListener("change",()=>{H.checked?(R.setAttribute("data-theme","dark"),localStorage.setItem("theme","dark"),U.src="/Images/logo-dark-theme_optimized_.png"):(R.setAttribute("data-theme","light"),localStorage.setItem("theme","light"),U.src="/Images/logo_optimized.png")})}function De(){localStorage.getItem("theme")==="dark"?(R.setAttribute("data-theme","dark"),H&&(H.checked=!0)):R.setAttribute("data-theme","light")}function he(e){e==="dark"?(de.classList.add("dark"),U.src="/Images/logo-dark-theme_optimized_.png"):(de.classList.remove("dark"),U.src="/Images/logo_optimized.png"),localStorage.setItem("theme",e)}function pe(){Ue(),Ae(),Fe(),xe(),qe(),Ne()}function ee(){document.querySelectorAll(".user-icon").forEach(e=>{e.addEventListener("click",n=>{n.stopPropagation();const a=window.currentUser;a&&a.id?(v.classList.toggle("show"),O.classList.add("hidden")):(v.classList.remove("show"),O.classList.remove("hidden"),T.classList.add("active"),M.classList.remove("active"),$.classList.remove("hidden"),I.classList.add("hidden"))})})}let je,X;function N(e="allPostsContainer",n=6){clearTimeout(je);const a=document.getElementById(e);if(!a)return;let t=a.previousElementSibling?.classList.contains("skeleton-wrapper")?a.previousElementSibling:null;t||(t=document.createElement("div"),t.className="skeleton-wrapper",a.before(t)),t.innerHTML="",t.classList.remove("hidden");for(let s=0;s<n;s++){let o="";e==="savedPostsContainer"?o=`
