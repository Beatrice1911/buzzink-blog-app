(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))a(t);new MutationObserver(t=>{for(const n of t)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function s(t){const n={};return t.integrity&&(n.integrity=t.integrity),t.referrerPolicy&&(n.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?n.credentials="include":t.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(t){if(t.ep)return;t.ep=!0;const n=s(t);fetch(t.href,n)}})();const w="/api/posts",U="/api/auth",_="/api/comments",ae="https://i.postimg.cc/KvF0rh0Q/custom-default-avatar.png",X=document.body,j=document.querySelectorAll(".user-icon"),p=document.getElementById("userMenuDetails"),q=document.getElementById("authModal"),ie=document.getElementById("closeModal"),B=document.getElementById("loginTab"),S=document.getElementById("registerTab"),re=document.querySelectorAll(".write-post"),le=document.querySelector(".search-icon"),R=document.getElementById("mobileSearch"),ce=document.querySelector(".menu-toggle"),de=document.getElementById("mobileMenu"),C=document.querySelector(".logo"),me=document.querySelector(".all-posts-btn"),ue=document.getElementById("myPosts"),ge=document.getElementById("savedPosts"),fe=document.getElementById("profile-edit"),he=document.getElementById("settings"),x=document.getElementById("themeToggle");function l(e,o="info",s=5e3){const a=document.getElementById("toast-container");if(!a)return;const t=document.createElement("div");t.className=`toast toast-${o}`;const n=document.createElement("i");o==="success"?n.className="fas fa-check-circle":o==="error"?n.className="fas fa-exclamation-circle":n.className="fas fa-info-circle",t.appendChild(n);const i=document.createElement("span");i.textContent=e,t.appendChild(i),a.appendChild(t),setTimeout(()=>{t.style.animation="slideOut 0.5s forwards",t.addEventListener("animationend",()=>t.remove())},s)}function ye(){ce?.addEventListener("click",e=>{e.stopPropagation(),p.classList.contains("show")&&p.classList.remove("show"),de.classList.toggle("active")})}function pe(){C?.addEventListener("click",()=>{window.location.href="index.html"}),me?.addEventListener("click",()=>{window.location.href="all-posts.html"}),ue?.addEventListener("click",()=>{window.location.href="my-posts.html"}),fe?.addEventListener("click",()=>{window.location.href="dashboard.html"}),ge?.addEventListener("click",()=>{window.location.href="saved.html"}),he?.addEventListener("click",()=>{window.location.href="settings.html"})}function we(){B?.addEventListener("click",()=>{k.classList.remove("hidden"),v.classList.add("hidden"),B.classList.add("active"),S.classList.remove("active")}),S?.addEventListener("click",()=>{v.classList.remove("hidden"),k.classList.add("hidden"),S.classList.add("active"),B.classList.remove("active")}),ie?.addEventListener("click",()=>{q.classList.add("hidden")})}function ke(){j.forEach(e=>e?.addEventListener("click",()=>{const o=localStorage.getItem("user"),s=o?JSON.parse(o):null;s&&s.id?(p.classList.toggle("show"),q.classList.add("hidden")):(p.classList.add("hidden"),q.classList.remove("hidden"),B.classList.add("active"),S.classList.remove("active"),k.classList.remove("hidden"),v.classList.add("hidden"),k?.reset(),v?.reset())}))}function ve(){le?.addEventListener("click",()=>{R.classList.toggle("show"),R.classList.contains("show")&&R.querySelector("input").focus()})}function Le(){re.forEach(e=>{e.addEventListener("click",o=>{const s=localStorage.getItem("user"),a=s?JSON.parse(s):null;!a||!a.id?(o.preventDefault(),q.classList.remove("hidden"),B.classList.add("active"),S.classList.remove("active"),k.classList.remove("hidden"),v.classList.add("hidden")):(localStorage.removeItem("editSlug"),window.location.href="write.html")})})}function Ee(){x?.addEventListener("change",()=>{x.checked?(root.setAttribute("data-theme","dark"),localStorage.setItem("theme","dark"),C.src="/Images/logo-dark-theme_optimized_.png"):(root.setAttribute("data-theme","light"),localStorage.setItem("theme","light"),C.src="/Images/logo_optimized.png")})}function be(){const e=document.documentElement;localStorage.getItem("theme")==="dark"?(e.setAttribute("data-theme","dark"),x&&(x.checked=!0)):e.setAttribute("data-theme","light")}function Ie(e){e==="dark"?(X.classList.add("dark"),C.src="/Images/logo-dark-theme_optimized_.png"):(X.classList.remove("dark"),C.src="/Images/logo_optimized.png"),localStorage.setItem("theme",e)}function $e(){ye(),we(),ke(),ve(),Le(),pe(),Ee()}async function Be(e){const o=e.dataset.postId;if(!o)return;const s=window.location.pathname.endsWith("post.html"),a=s?document.getElementById("singlePostContainer"):e.closest(".post");if(!a)return;const t=a.querySelector(".comments-section"),n=t?.querySelector(".comments-list");!t||!n||(s||t.classList.toggle("show"),(s||t.classList.contains("show"))&&await Pe(o,n))}async function Se(e){if(e.dataset.deleting==="true")return;e.dataset.deleting="true";const o=e.dataset.commentId;if(!confirm("Are you sure you want to delete this comment?")){e.dataset.deleting="false";return}try{const a=await d(`${_}/${o}`,{method:"DELETE"}),t=await a.json();if(a.ok){const n=e.closest(".comment");n&&n.remove();let i;if(window.location.pathname.endsWith("post.html")?i=document.getElementById("singlePostContainer")?.querySelector(".comment-count"):i=e.closest(".post")?.querySelector(".comment-count"),i){const r=parseInt(i.textContent)||0;i.textContent=Math.max(0,r-1)}l("Comment deleted successfully!","success")}else throw new Error(t.message||"Delete failed")}catch(a){console.error("Error deleting comment:",a),l("Error deleting comment. Please try again.","error")}finally{e.dataset.deleting="false"}}async function Pe(e,o,s=3){try{o.innerHTML='<p class="loading-comments">Loading comments...</p>';const a=await d(`${_}/post/${e}?_=${Date.now()}`);if(!a.ok)throw new Error("Failed to fetch comments");const t=await a.json();if(o.innerHTML="",t.length===0){o.innerHTML="<p class='no-comments'>No comments yet. Be the first to comment!</p>";return}const n=t.slice(0,s);if(W(n,o),t.length>s){const i=document.createElement("button");i.classList.add("view-more-btn"),i.textContent=`View all ${t.length} comments`;const r=document.createElement("div");r.classList.add("comments-scroll-container"),r.style.display="none",W(t,r);let u=!1;i.addEventListener("click",()=>{u=!u,u?(o.innerHTML="",o.appendChild(r),o.appendChild(i),r.style.display="block",i.textContent="View less comments"):(o.innerHTML="",W(n,o),i.textContent=`View all ${t.length} comments`,o.appendChild(i))}),o.appendChild(i)}}catch(a){console.error("Error fetching comments:",a),o.innerHTML="<p class='error-comments'>Failed to load comments.</p>"}}function W(e,o){const s=window.currentUser?.id||window.currentUser?._id;e.forEach(a=>{const t=document.createElement("div");t.classList.add("comment");const n=typeof a.authorId=="object"?a.authorId._id:a.authorId,i=s&&n&&n.toString()===s.toString();t.innerHTML=`
    ...
    `,o.appendChild(t),t.querySelector(".comment-author")?.addEventListener("click",()=>{window.location.href=`profile.html?id=${a.authorId?._id}`})})}async function Ce(e,o,s,a){try{const t=await d(`${_}/post/${e}`,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"include",body:JSON.stringify({text:o})});if(t.ok){const n=await t.json(),i=document.createElement("div");i.classList.add("comment"),i.innerHTML=`
        <div class="comment-header">
  ...
  `).join("")};function _e(e){const o=document.getElementById("related-posts-container");if(!e.length){o.innerHTML="<p>No related posts found.</p>";return}o.innerHTML=e.map(s=>`
    ...
    `,a.appendChild(i);const r=i.querySelector(".post-image");r&&(r.onerror=function(){this.onerror=null,this.src="/Images/fallback.jpg"}),i.addEventListener("click",()=>{window.location.href=`post.html?slug=${n.slug}`})}),o===""&&F()}Ae.forEach(e=>e.addEventListener("keyup",He));function te(){const e=document.getElementById("pagination");if(e){e.innerHTML="";for(let o=1;o<=Y;o++){const s=document.createElement("button");s.textContent=o,s.className=o===M?"pg-active":"",s?.addEventListener("click",()=>O(o)),e.appendChild(s)}}}const k=document.getElementById("loginForm"),v=document.getElementById("registerForm"),ze=document.getElementById("logoutBtn");function H(e){return e?{...e,id:e.id||e._id}:null}window.currentUser=(()=>{const e=localStorage.getItem("user");return e?H(JSON.parse(e)):null})();function $(e){e?.id?j.forEach(o=>o.title=`Logged in as ${e.name}`):(j.forEach(o=>o.title="Click to Login/Register"),p?.classList.remove("show"))}async function A(e){try{const o=await d("/api/users/me",{credentials:"include"});if(!o.ok)return;e=await o.json();const s=document.querySelectorAll(".user-icon");s&&s.forEach(a=>{a.src=e.profilePhoto?.trim()?e.profilePhoto:ae}),window.currentUser=e}catch(o){console.warn("Failed to load auth user:",o)}}function Re(){k?.addEventListener("submit",async e=>{e.preventDefault();const o=document.getElementById("loginEmail").value,s=document.getElementById("loginPassword").value;console.log("Login Triggered");const a=await d(`${U}/login`,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"include",body:JSON.stringify({email:o,password:s})}),t=await a.json();console.log("Login response:",t),a.ok||l(`Login failed: ${t.message||"Unknown error"}`,"error");const n=H(t.user);localStorage.setItem("user",JSON.stringify(n)),window.currentUser=n,localStorage.setItem("role",n.role),n.role==="admin"&&(window.location.href="admin.html"),$(n),A(n),authModal.classList.add("hidden"),k.reset(),l(`Welcome back, ${n.name}!`,"success"),F()})}function We(){v?.addEventListener("submit",async e=>{e.preventDefault();const o=document.getElementById("registerName").value,s=document.getElementById("registerEmail").value,a=document.getElementById("registerPassword").value,t=await d(`${U}/register`,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"include",body:JSON.stringify({name:o,email:s,password:a})}),n=await t.json();console.log("Register response:",n),t.ok||l(`Registration failed: ${n.message||"Unknown error"}`,"error");const i=H(n.user);localStorage.setItem("user",JSON.stringify(i)),window.currentUser=i,localStorage.setItem("role",i.role),$(i),A(i),authModal.classList.add("hidden"),v.reset(),l(`Welcome, ${i.name}! Your account has been created.`,"success")})}function Je(){ze?.addEventListener("click",()=>{ne(),window.location.href="index.html"})}async function Ve(){try{const e=await d(`${U}/me`,{credentials:"include"});if(!e.ok)throw new Error("Not authenticated");const o=await e.json(),s=H(o);return localStorage.setItem("user",JSON.stringify(s)),window.currentUser=s,$(s),A(s),s}catch{return $(null),A(null),null}}async function ne(e=!1){try{await fetch(`${U}/logout`,{method:"POST",credentials:"include"})}catch(o){console.warn("Logout request failed:",o)}localStorage.removeItem("user"),window.currentUser=null,$(null),e||l("You have been logged out.","info")}function Ye(){const e=document.getElementById("forgotPasswordLink"),o=document.getElementById("forgotPasswordModal"),s=document.getElementById("closeForgotModal"),a=document.getElementById("forgotPasswordForm");e&&e.addEventListener("click",t=>{t.preventDefault(),o.classList.remove("hidden")}),s&&s.addEventListener("click",()=>{o.classList.add("hidden")}),a&&a.addEventListener("submit",async t=>{t.preventDefault();const n=document.getElementById("forgotEmail").value.trim();try{const r=await(await fetch("/api/auth/forgot-password",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:n})})).json();l(r.message||"Check your email for the reset link.","success"),o.classList.add("hidden")}catch(i){console.error(i),l("Failed to send reset link. Try again.","error")}})}function Ke(){Re(),We(),Je(),Ye()}async function d(e,o={}){let s=await fetch(e,{credentials:"include",...o});return s.status===401&&(await Qe()?s=await fetch(e,{credentials:"include",...o}):ne(!0)),s}async function Qe(){try{const e=await fetch(`${U}/refresh`,{method:"POST",credentials:"include"});if(!e.ok)throw new Error("Refresh failed");const o=await e.json();return window.currentUser=o.user,$(o.user),!0}catch{return!1}}function Ge(){window.location.pathname.endsWith("post.html")&&(async()=>{const o=new URLSearchParams(window.location.search).get("slug");if(!o)return;const a=await(await d(`/api/posts/${o}`)).json();document.title=`${a.title} | BuzzInk`;const t=a.content.slice(0,160);document.getElementById("postTitle")?.setAttribute("content",a.title),document.getElementById("postDescription")?.setAttribute("content",t),document.getElementById("ogTitle")?.setAttribute("content",a.title),document.getElementById("ogDescription")?.setAttribute("content",t),document.getElementById("ogImage")?.setAttribute("content",a.image||"/Images/fallback.jpg"),document.getElementById("ogUrl")?.setAttribute("content",window.location.href),document.getElementById("twitterTitle")?.setAttribute("content",a.title),document.getElementById("twitterDescription")?.setAttribute("content",t),document.getElementById("twitterImage")?.setAttribute("content",a.image||"/Images/fallback.jpg")})()}async function Xe(e){const o=e.dataset.postId,s=e.querySelector("i"),a=e.querySelector(".like-count"),t=e.closest(".post-interactions-container")?.querySelector(".liked-by"),n=e.classList.contains("liked");if(!window.currentUser){l("Please log in to like or unlike posts.","error");return}try{let i;n?i=await d(`/api/posts/${o}/unlike`,{method:"POST",credentials:"include"}):i=await d(`/api/posts/${o}/like`,{method:"POST",credentials:"include"});const r=await i.json();i.ok?(n?(e.classList.remove("liked"),s.className="fa-regular fa-heart"):(e.classList.add("liked"),s.className="fa-solid fa-heart"),a.textContent=r.likes??0,t.dataset.postId=o,t.dataset.likedBy=JSON.stringify(r.likedBy||[]),r.likedBy&&r.likedBy.length>0?(t.classList.remove("disabled"),r.likedBy.length===1?t.textContent=`Liked by ${r.likedBy[0]}`:t.textContent=`Liked by ${r.likedBy[0]} and ${r.likedBy.length-1} others`):(t.classList.add("disabled"),t.textContent="No likes yet")):l(`Failed to update likes: ${r.message}`,"error")}catch(i){console.error("Like action failed:",i),l("Error updating like. Please try again.","error")}}let K=!1;function Ze(e,o){const s=document.getElementById(`likesModal-${e}`),a=document.getElementById(`likesList-${e}`);if(!s||!a)return;a.innerHTML="",o.forEach(n=>{const i=document.createElement("li");i.textContent=n,a.appendChild(i)}),s.classList.remove("hidden"),requestAnimationFrame(()=>s.classList.add("active")),K=!0,s.querySelector(".likes-modal-content").addEventListener("click",n=>n.stopPropagation()),document.getElementById(`closeLikesModal-${e}`)?.addEventListener("click",n=>{n.stopPropagation(),oe(e)},{once:!0})}function oe(e){const o=document.getElementById(`likesModal-${e}`);o&&(o.classList.remove("active"),setTimeout(()=>{o.classList.add("hidden"),K=!1},300))}function et(){document.addEventListener("click",async e=>{const o=e.target.closest(".edit-btn");if(o){e.preventDefault(),e.stopPropagation(),editPost(o.dataset.slug);return}const s=e.target.closest(".delete-btn");if(s){e.preventDefault(),e.stopPropagation(),je(s.dataset.slug);return}const a=e.target.closest(".like-btn");if(a){e.preventDefault(),Xe(a);return}const t=e.target.closest(".comment-btn");if(t){e.preventDefault(),Be(t);return}const n=e.target.closest(".likes-info");if(n&&!n.classList.contains("disabled")){e.preventDefault(),e.stopPropagation();const c=n.dataset.postId,f=JSON.parse(n.dataset.likedBy||"[]");if(!c||f.length===0)return;Ze(c,f);return}if(K){const c=document.querySelector(".likes-modal.active");if(c&&!c.contains(e.target)){const f=c.id.replace("likesModal-","");oe(f)}}const i=e.target.closest(".delete-comment-btn");i&&(e.preventDefault(),e.stopPropagation(),Se(i));const r=e.target.closest(".menu-btn"),u=e.target.closest(".menu-options");if(!r&&!u){document.querySelectorAll(".menu-options").forEach(c=>c.classList.add("hidden"));return}r&&r.nextElementSibling.classList.toggle("hidden"),p?.classList.contains("show")&&!p.contains(e.target)&&![...j].some(c=>c.contains(e.target))&&p.classList.remove("show"),mobileMenu?.classList.contains("active")&&!mobileMenu.contains(e.target)&&!menuToggle.contains(e.target)&&mobileMenu.classList.remove("active")})}document.getElementById("canonicalUrl")?.setAttribute("href",window.location.href);function tt(){const e=window.location.pathname;e==="/"||e.endsWith("index.html")?(O(),Oe()):e.endsWith("my-posts.html")?ee():e.endsWith("post.html")?xe():e.endsWith("saved.html")?Fe():O()}document.addEventListener("DOMContentLoaded",async()=>{const e=await Ve();window.currentUser=e,await A(e),Ge(),et(),Ke(),$e(),Me(),be();const o=localStorage.getItem("theme")||"light";Ie(o),tt(),F()});
