(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))t(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&t(r)}).observe(document,{childList:!0,subtree:!0});function a(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function t(s){if(s.ep)return;s.ep=!0;const o=a(s);fetch(s.href,o)}})();const p="/api/posts",M="/api/auth",W="/api/comments",ie="https://i.postimg.cc/KvF0rh0Q/custom-default-avatar.png",le=document.body,ce=document.querySelectorAll(".user-icon"),S=document.getElementById("userMenuDetails"),me=document.getElementById("authModal"),Ee=document.getElementById("closeModal"),N=document.getElementById("loginTab"),D=document.getElementById("registerTab"),Se=document.querySelectorAll(".write-post"),$e=document.querySelector(".search-icon"),K=document.getElementById("mobileSearch"),ge=document.querySelector(".menu-toggle"),j=document.getElementById("mobileMenu"),B=document.querySelector(".logo"),Ie=document.querySelector(".all-posts-btn"),Pe=document.getElementById("myPosts"),Be=document.getElementById("savedPosts"),Ce=document.getElementById("profile-edit"),Te=document.getElementById("settings"),O=document.getElementById("themeToggle"),H=document.documentElement;function d(e,n="info",a=5e3){const t=document.getElementById("toast-container");if(!t)return;const s=document.createElement("div");s.className=`toast toast-${n}`;const o=document.createElement("i");n==="success"?o.className="fas fa-check-circle":n==="error"?o.className="fas fa-exclamation-circle":o.className="fas fa-info-circle",s.appendChild(o);const r=document.createElement("span");r.textContent=e,s.appendChild(r),t.appendChild(s),setTimeout(()=>{s.style.animation="slideOut 0.5s forwards",s?.addEventListener("animationend",()=>s.remove())},a)}function Me(){ge?.addEventListener("click",e=>{e.stopPropagation(),S.classList.contains("show")&&S.classList.remove("show"),j.classList.toggle("active")})}function Ue(){B?.addEventListener("click",()=>{window.location.href="index.html"}),Ie?.addEventListener("click",()=>{window.location.href="all-posts.html"}),Pe?.addEventListener("click",()=>{window.location.href="my-posts.html"}),Ce?.addEventListener("click",()=>{window.location.href="dashboard.html"}),Be?.addEventListener("click",()=>{window.location.href="saved.html"}),Te?.addEventListener("click",()=>{window.location.href="settings.html"})}function qe(){N?.addEventListener("click",()=>{C.classList.remove("hidden"),T.classList.add("hidden"),N.classList.add("active"),D.classList.remove("active")}),D?.addEventListener("click",()=>{T.classList.remove("hidden"),C.classList.add("hidden"),D.classList.add("active"),N.classList.remove("active")}),Ee?.addEventListener("click",()=>{me.classList.add("hidden")})}function Fe(){$e?.addEventListener("click",()=>{K.classList.toggle("show"),K.classList.contains("show")&&K?.querySelector("input").focus()})}function Ae(){Se.forEach(e=>{e?.addEventListener("click",n=>{const a=localStorage.getItem("user"),t=a?JSON.parse(a):null;!t||!t.id?(n.preventDefault(),me.classList.remove("hidden"),N.classList.add("active"),D.classList.remove("active"),C.classList.remove("hidden"),T.classList.add("hidden")):(localStorage.removeItem("editSlug"),window.location.href="write.html")})})}function xe(){O?.addEventListener("change",()=>{O.checked?(H.setAttribute("data-theme","dark"),localStorage.setItem("theme","dark"),B.src="/Images/logo-dark-theme_optimized_.png"):(H.setAttribute("data-theme","light"),localStorage.setItem("theme","light"),B.src="/Images/logo_optimized.png")})}function Ne(){localStorage.getItem("theme")==="dark"?(H.setAttribute("data-theme","dark"),O&&(O.checked=!0)):H.setAttribute("data-theme","light")}function fe(e){e==="dark"?(le.classList.add("dark"),B.src="/Images/logo-dark-theme_optimized_.png"):(le.classList.remove("dark"),B.src="/Images/logo_optimized.png"),localStorage.setItem("theme",e)}function he(){Me(),qe(),Fe(),Ae(),Ue(),xe()}let De,G;function A(e="allPostsContainer",n=6){clearTimeout(De);const a=document.getElementById(e);if(!a)return;let t=a.previousElementSibling?.classList.contains("skeleton-wrapper")?a.previousElementSibling:null;t||(t=document.createElement("div"),t.className="skeleton-wrapper",a.before(t)),t.innerHTML="",t.classList.remove("hidden");for(let s=0;s<n;s++){let o="";e==="savedPostsContainer"?o=`
  ...
  `).join("")};function ot(e){const n=document.getElementById("related-posts-container");if(!e.length){n.innerHTML="<p style='margin: 0 5px;'>No related posts found.</p>";return}n.innerHTML=e.map(a=>`
    ...
    `).join("")}const nt=async e=>{try{const a=await(await u(`${p}/slug/${e}/related`)).json();ot(a)}catch(n){console.error("Failed to fetch related posts.",n)}},at=document.getElementById("savedPostsContainer");async function re(e,n=6){const a=at;try{const t=v(),s=e??t.page,o=V()||t.search;b({page:s,search:o},{replace:!0});const r=new URLSearchParams({page:s,limit:n});o&&r.append("search",o),s!==1&&Z();const i=await u(`${p}/saved/me?${r.toString()}`);if(!i.ok)throw new Error("Failed to fetch");const l=await i.json();if(f.saved=Array.isArray(l.posts)?l.posts:[],L=l.totalPages||1,!a)return;if(f.saved.length===0){a.innerHTML="<p>You have no saved posts yet.</p>";return}a.innerHTML=f.saved.map(c=>`
