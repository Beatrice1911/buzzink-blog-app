(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))t(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&t(r)}).observe(document,{childList:!0,subtree:!0});function a(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function t(s){if(s.ep)return;s.ep=!0;const o=a(s);fetch(s.href,o)}})();const p="/api/posts",q="/api/auth",z="/api/comments",le="https://i.postimg.cc/KvF0rh0Q/custom-default-avatar.png",ce=document.body,de=document.querySelectorAll(".user-icon"),y=document.getElementById("userMenuDetails"),O=document.getElementById("authModal"),Ee=document.getElementById("closeModal"),T=document.getElementById("loginTab"),M=document.getElementById("registerTab"),Se=document.querySelectorAll(".write-post"),$e=document.querySelector(".search-icon"),Q=document.getElementById("mobileSearch"),ge=document.querySelector(".menu-toggle"),j=document.getElementById("mobileMenu"),U=document.querySelector(".logo"),Ie=document.querySelector(".all-posts-btn"),Pe=document.getElementById("myPosts"),Be=document.getElementById("savedPosts"),Ce=document.getElementById("profile-edit"),Te=document.getElementById("settings"),H=document.getElementById("themeToggle"),R=document.documentElement;function d(e,n="info",a=5e3){const t=document.getElementById("toast-container");if(!t)return;const s=document.createElement("div");s.className=`toast toast-${n}`;const o=document.createElement("i");n==="success"?o.className="fas fa-check-circle":n==="error"?o.className="fas fa-exclamation-circle":o.className="fas fa-info-circle",s.appendChild(o);const r=document.createElement("span");r.textContent=e,s.appendChild(r),t.appendChild(s),setTimeout(()=>{s.style.animation="slideOut 0.5s forwards",s?.addEventListener("animationend",()=>s.remove())},a)}function Me(){ge?.addEventListener("click",e=>{e.stopPropagation(),y.classList.contains("show")&&y.classList.remove("show"),j.classList.toggle("active")})}function Ue(){U?.addEventListener("click",()=>{window.location.href="index.html"}),Ie?.addEventListener("click",()=>{window.location.href="all-posts.html"}),Pe?.addEventListener("click",()=>{window.location.href="my-posts.html"}),Ce?.addEventListener("click",()=>{window.location.href="dashboard.html"}),Be?.addEventListener("click",()=>{window.location.href="saved.html"}),Te?.addEventListener("click",()=>{window.location.href="settings.html"})}function qe(){T?.addEventListener("click",()=>{S.classList.remove("hidden"),$.classList.add("hidden"),T.classList.add("active"),M.classList.remove("active")}),M?.addEventListener("click",()=>{$.classList.remove("hidden"),S.classList.add("hidden"),M.classList.add("active"),T.classList.remove("active")}),Ee?.addEventListener("click",()=>{O.classList.add("hidden")})}function Fe(){$e?.addEventListener("click",()=>{Q.classList.toggle("show"),Q.classList.contains("show")&&Q?.querySelector("input").focus()})}function Ae(){Se.forEach(e=>{e?.addEventListener("click",n=>{const a=localStorage.getItem("user"),t=a?JSON.parse(a):null;!t||!t.id?(n.preventDefault(),O.classList.remove("hidden"),T.classList.add("active"),M.classList.remove("active"),S.classList.remove("hidden"),$.classList.add("hidden")):(localStorage.removeItem("editSlug"),window.location.href="write.html")})})}function xe(){H?.addEventListener("change",()=>{H.checked?(R.setAttribute("data-theme","dark"),localStorage.setItem("theme","dark"),U.src="/Images/logo-dark-theme_optimized_.png"):(R.setAttribute("data-theme","light"),localStorage.setItem("theme","light"),U.src="/Images/logo_optimized.png")})}function Ne(){localStorage.getItem("theme")==="dark"?(R.setAttribute("data-theme","dark"),H&&(H.checked=!0)):R.setAttribute("data-theme","light")}function fe(e){e==="dark"?(ce.classList.add("dark"),U.src="/Images/logo-dark-theme_optimized_.png"):(ce.classList.remove("dark"),U.src="/Images/logo_optimized.png"),localStorage.setItem("theme",e)}function he(){Me(),qe(),Fe(),Ae(),Ue(),xe()}let De,X;function N(e="allPostsContainer",n=6){clearTimeout(De);const a=document.getElementById(e);if(!a)return;let t=a.previousElementSibling?.classList.contains("skeleton-wrapper")?a.previousElementSibling:null;t||(t=document.createElement("div"),t.className="skeleton-wrapper",a.before(t)),t.innerHTML="",t.classList.remove("hidden");for(let s=0;s<n;s++){let o="";e==="savedPostsContainer"?o=`
    ...
    `;const c=l.querySelector(".post-image");c&&(c.onerror=function(){this.onerror=null,this.src="/Images/fallback.jpg"});const h=l?.querySelector(".like-btn"),v=h?.querySelector("i"),g=l?.querySelector(".liked-by");g.dataset.slug=t.slug,g.dataset.likedBy=JSON.stringify(t.likedBy||[]),h.classList.toggle("liked",t.likedByUser),v.className=t.likedByUser?"fa-solid fa-heart":"fa-regular fa-heart",t.likesCount?(g.textContent=t.likesCount===1?`Liked by ${t.likedBy[0]}`:`Liked by ${t.likedBy[0]} and ${t.likedBy.length-1} others`,g.classList.remove("disabled")):(g.textContent="No likes yet",g.classList.add("disabled"));const w=l.querySelector(".comment-count");ve(t.slug,w);const m=document.querySelector(".comments-section"),A=m.querySelector(".comments-list");m&&A&&await ye(t.slug,A,1/0);const k=l.querySelector(".bookmark");k?.addEventListener("click",async()=>{const b=k.dataset.slug,P=k.dataset.saved==="true";if(!window.currentUser){d("Please log in to save posts");return}k.classList.add("clicked"),setTimeout(()=>k.classList.remove("clicked"),200);const Le=P?`/api/posts/${b}/unsave`:`/api/posts/${b}/save`;try{const x=await u(Le,{method:"POST"}),be=await x.json();if(!x.ok)throw new Error(be.message||"Failed to toggle bookmark");ke(!P),d(P?"Removed from saved posts":"Post saved","success")}catch(x){console.error("Failed to toggle bookmark",x),d("Something went wrong","error")}})}catch(a){console.error(a),document.getElementById("singlePostContainer").innerHTML="<p>Error loading post.</p>"}nt(n)}}const st=async()=>{const n=await(await u(`${p}/trending?limit=5`)).json(),a=document.getElementById("trending-list");a.innerHTML=n.map((t,s)=>`
    <li>
  ...
  `).join("")};function ot(e){const n=document.getElementById("related-posts-container");if(!e.length){n.innerHTML="<p style='margin: 0 5px;'>No related posts found.</p>";return}n.innerHTML=e.map(a=>`
    ...
    `).join(""),document.querySelectorAll(".bookmark").forEach(c=>{c?.addEventListener("click",async h=>{h.stopPropagation();const v=c.dataset.slug;try{await u(`${p}/${v}/unsave`,{method:"POST"}),f.saved=f.saved.filter(w=>w.slug!==v),c.closest(".post-card").remove(),d("Removed from saved posts","success");const{page:g}=L();f.saved.length===0&&g>1?ie(g-1):W("savedPostsContainer",g,E)}catch(g){console.error(g),d("Failed to remove","error")}})}),W("savedPostsContainer",s,E)}catch(t){console.error(t),a.innerHTML="<p>Error loading saved posts.</p>"}finally{J(),te()}}document.getElementById("categoryFilter")?.addEventListener("change",()=>{I({page:1}),C(1)});let me;se.forEach(e=>e?.addEventListener("keyup",()=>{clearTimeout(me),me=setTimeout(()=>{I({page:1}),we(),C(1),ne(1),ie(1)},400)}));function W(e,n,a){const t=document.getElementById("pagination");if(t){t.innerHTML="";for(let s=1;s<=a;s++){const o=document.createElement("button");o.textContent=s,o.className=s===n?"pg-active":"",o?.addEventListener("click",async()=>{I({page:s}),C(s)}),t.appendChild(o)}}}async function rt(e){const n=e.dataset.slug,a=e.querySelector("i"),t=e.querySelector(".like-count"),s=e.closest(".post-interactions-container")?.querySelector(".liked-by");if(!window.currentUser){d("Please log in to like or unlike posts.","error");return}const o=e.classList.contains("liked");try{const r=await u(`/api/posts/${n}/${o?"unlike":"like"}`,{method:"POST"}),i=await r.json();if(r.ok){e.classList.toggle("liked",!o),a.className=o?"fa-regular fa-heart":"fa-solid fa-heart";const l=i.likesCount??i.likes??0;t.textContent=l,s&&(l?(s.textContent=l===1?"1 like":`${l} likes`,s.classList.remove("disabled")):(s.textContent="No likes yet",s.classList.add("disabled")),Array.isArray(i.likedBy)&&(s.dataset.slug=n,s.dataset.likedBy=JSON.stringify(i.likedBy)))}else d(`Failed to update likes: ${i.message}`,"error")}catch(r){console.error("Like action failed:",r),d("Error updating like. Please try again.","error")}}const it=async e=>{const n=e.dataset.slug,a=`${window.location.origin}/post/${n}`,t=`shared_${n}`;try{navigator.share?await navigator.share({title:"BuzzInk",text:"Check out this post on BuzzInk",url:a}):(await navigator.clipboard.writeText(a),d("Link copied to clipboard!","success")),sessionStorage.getItem(t)||(sessionStorage.setItem(t,"true"),u(`/api/posts/${n}/share`,{method:"POST"}).catch(()=>{}));const s=e.querySelector(".share-count");s&&(s.textContent=Number(s.textContent)+1)}catch(s){d("Failed to share post. Please try again.","error"),console.error("Share cancelled or failed",s)}};let Z=!1;async function lt(e){if(Z)return;const n=encodeURIComponent(e),a=document.getElementById(`likesModal-${n}`),t=document.getElementById(`likesList-${n}`);if(!(!a||!t)&&!a.classList.contains("active")){Z=!0,a.classList.remove("hidden"),requestAnimationFrame(()=>a.classList.add("active")),t.innerHTML="<li>Loading...</li>";try{const o=await(await u(`/api/posts/${e}/likes`)).json();if(t.innerHTML="",!Array.isArray(o.users)||o.users.length===0){t.innerHTML="<li>No likes yet</li>";return}o.users.forEach(r=>{const i=document.createElement("li");i.textContent=r,t.appendChild(i)})}catch(s){t.innerHTML="<li>Failed to load likes</li>",console.error("Failed to fetch likes:",s)}}}function ct(e){const n=encodeURIComponent(e),a=document.getElementById(`likesModal-${n}`);a&&(Z=!1,a.classList.remove("active"),setTimeout(()=>{a.classList.add("hidden")},300))}function dt(){document.addEventListener("click",async e=>{const n=e.target.closest(".edit-btn");if(n){e.preventDefault(),e.stopPropagation(),et(n.dataset.slug);return}const a=e.target.closest(".delete-btn");if(a){e.preventDefault(),e.stopPropagation(),Ze(a.dataset.slug);return}const t=e.target.closest(".like-btn");if(t){e.preventDefault(),rt(t);return}const s=e.target.closest(".comment-btn");if(s){e.preventDefault(),Ve(s);return}const o=e.target.closest(".share-btn");if(o){e.preventDefault(),it(o);return}const r=e.target.closest(".likes-info");if(r&&!r.classList.contains("disabled")){e.preventDefault(),e.stopPropagation();const m=r.dataset.slug;if(!m)return;lt(m);return}const i=document.querySelector(".likes-modal.active");if(i&&!i.contains(e.target)){const m=i.id.replace("likesModal-","");ct(m)}const l=e.target.closest(".delete-comment-btn");l&&(e.preventDefault(),e.stopPropagation(),Ye(l));const c=e.target.closest(".menu-btn"),h=e.target.closest(".menu-options");if(!c&&!h&&document.querySelectorAll(".menu-options").forEach(m=>m.classList.add("hidden")),c&&c.nextElementSibling.classList.toggle("hidden"),y?.classList.contains("show")&&!y.contains(e.target)&&!e.target.closest(".user-icon")&&y.classList.remove("show"),j?.classList.contains("active")&&!j.contains(e.target)&&!ge.contains(e.target)&&j.classList.remove("active"),!e.target.closest(".user-icon"))return;e.stopPropagation();const g=localStorage.getItem("user"),w=g?JSON.parse(g):null;w&&w.id?(y.classList.toggle("show"),y?.addEventListener("click",m=>m.stopPropagation()),O.classList.add("hidden")):(y.classList.add("hidden"),O.classList.remove("hidden"),T.classList.add("active"),M.classList.remove("active"),S.classList.remove("hidden"),$.classList.add("hidden"),S?.reset(),$?.reset())})}document.getElementById("canonicalUrl")?.setAttribute("href",window.location.href);"scrollRestoration"in history&&(history.scrollRestoration="manual");function ut(){const e=`scroll:${window.location.pathname}${window.location.search}`,n=sessionStorage.getItem(e);n!==null&&(window.scrollTo(0,Number(n)),sessionStorage.removeItem(e))}async function K(){const e=window.location.pathname,{page:n}=L();e==="/"||e.endsWith("index.html")?(D(),N("featuredPostsContainer",3),await we(),await C(n),await st()):e.endsWith("my-posts.html")?(D(),N("myPostsContainer",6),await ne(n)):e.endsWith("post.html")?await ue():e.endsWith("saved.html")?(D(),N("savedPostsContainer",6),await ie(n)):e.startsWith("/post/")?ue():(D(),N(),await C(n)),ut()}document.addEventListener("DOMContentLoaded",async()=>{const e=await _e();window.currentUser=e,ze(),he(),dt(),Ge(),Ne();const n=localStorage.getItem("theme")||"light";fe(n),await K(),window.location.pathname.endsWith("write.html")&&!localStorage.getItem("editSlug")&&localStorage.removeItem("editSlug"),tt()});window.addEventListener("pageshow",e=>{if(e.persisted){const n=localStorage.getItem("theme")||"light";fe(n),he()}});window.addEventListener("popstate",()=>{K()});export{u as a,pe as l,d as s};
